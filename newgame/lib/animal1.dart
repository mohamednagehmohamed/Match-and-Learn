...
class Animal1State extends State<Animal1> {
  static int scorer = 0;

  final Map<String, bool> score = {};
  final Map<String, Image> choices = {
    'Bat': Image.asset('assets/animal1/bat.png'),
    'Cow': Image.asset('assets/animal1/cow.png'),
    'Fox': Image.asset('assets/animal1/fox.png'),
    'Frog': Image.asset('assets/animal1/frog.png'),
    'Tortoise': Image.asset('assets/animal1/tortoise.png'),
  };
  int seed = 0;
              ...
              onPressed: () {
                setState(() {
                  Navigator.push(
                      context,
                      PageTransition(
                          child: Animal1(), type: PageTransitionType.fade));
                });
              },
