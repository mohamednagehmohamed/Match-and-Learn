...
class Color3State extends State<Color3> {
  static int scorer = 0;
          ...
          leading: IconButton(
              onPressed: () {
                setState(() {
                  if (score.length == 6) {
                    AlertDialog(
                      content: Text('You Finished Colors Round😄'),
                    );
                    Navigator.push(
                        context,
                        PageTransition(
                            child: Family(), type: PageTransitionType.fade));
                  }
                });
              },
              ...
              onPressed: () {
                setState(() {
                  Navigator.push(
                      context,
                      PageTransition(
                          child: Color3(), type: PageTransitionType.fade));
                });
              },
