...
class School2State extends State<School2> {
  static int scorer = 0;

  final Map<String, bool> score = {};
  final Map<String, Image> choices = {
    'Housekeaper': Image.asset('assets/school2/housekeeper.png'),
    'Manager': Image.asset('assets/school2/manager.png'),
    'Stationary': Image.asset('assets/school2/stationary.png'),
    'Student': Image.asset('assets/school2/student.png'),
    'Teacher': Image.asset('assets/school2/teacher.png'),
  };
  int seed = 0;
                ...
                setState(() {
                  if (score.length == 5) {
                    Navigator.push(
                        context,
                        PageTransition(
                            child: Round10(), type: PageTransitionType.fade));
                  }
                });
              },
