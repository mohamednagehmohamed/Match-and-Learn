...
class Round2State extends State<Round2> {
  static int scorer = 0;

  final Map<String, bool> score = {};
  final Map<String, Image> choices = {
    'Lion': Image.asset('assets/animals/lion.png'),
    'Tiger': Image.asset('assets/animals/tiger.png'),
    'Cat': Image.asset('assets/animals/cat.png'),
    'Dog': Image.asset('assets/animals/dog.png'),
    'Elephant': Image.asset('assets/animals/elephant.png'),
  };
  int seed = 0;
                ...
                setState(() {
                  if (score.length == 5) {
                    Navigator.push(
                        context,
                        PageTransition(
                            child: Animal(), type: PageTransitionType.fade));
                  }
                });
              },
              ...
              onPressed: () {
                setState(() {
                  Navigator.push(
                      context,
                      PageTransition(
                          child: Round2(), type: PageTransitionType.fade));
                });
              },
