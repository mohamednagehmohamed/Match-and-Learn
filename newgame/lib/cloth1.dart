...
class Cloth1 extends StatefulWidget {
  @override
...
class Cloth1State extends State<Cloth1> {
  static int scorer = 0;

  final Map<String, bool> score = {};
  final Map<String, Image> choices = {
    'Coat': Image.asset('assets/clothes1/coat.png'),
    'Jacket': Image.asset('assets/clothes1/jacket.png'),
    'Jeans': Image.asset('assets/clothes1/jeans.png'),
    'Shorts': Image.asset('assets/clothes1/shorts.png'),
    'Sweater': Image.asset('assets/clothes1/sweater.png'),
  };
  int seed = 0;
              ...
              onPressed: () {
                setState(() {
                  Navigator.push(
                      context,
                      PageTransition(
                          child: Cloth1(), type: PageTransitionType.fade));
                });
              },
