...
class Fruit1State extends State<Fruit1> {
  static int scorer = 0;

  final Map<String, bool> score = {};
  final Map<String, Image> choices = {
    'Cherry': Image.asset('assets/infruits/cherry.png'),
    'Grabes': Image.asset('assets/infruits/grapes.png'),
    'Orange': Image.asset('assets/infruits/orange.png'),
    'Pear': Image.asset('assets/infruits/pear.png'),
    'Strawbery': Image.asset('assets/infruits/strawberry.png'),
  };
  int seed = 0;
                ...
                setState(() {
                  if (score.length == 5) {
                    Navigator.push(
                        context,
                        PageTransition(
                            child: Fruit2(), type: PageTransitionType.fade));
                  }
                });
              },
              ...
              onPressed: () {
                setState(() {
                  Navigator.push(
                      context,
                      PageTransition(
                          child: Fruit1(), type: PageTransitionType.fade));
                });
              },
