...
class Round11State extends State<Round11> {
  static int scorer = 0;

  final Map<String, bool> score = {};
  final Map<String, Image> choices = {
    'Chemist': Image.asset('assets/jobs/chemist.png'),
    'Doctor': Image.asset('assets/jobs/doctor.png'),
    'Engineer': Image.asset('assets/jobs/engineer.png'),
    'Fireman': Image.asset('assets/jobs/fireman.png'),
    'Teacher': Image.asset('assets/jobs/teacher.png'),
  };
  int seed = 0;
              ...
              onPressed: () {
                setState(() {
                  Navigator.push(
                      context,
                      PageTransition(
                          child: Round11(), type: PageTransitionType.fade));
                });
              },
