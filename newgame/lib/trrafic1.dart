...
class Traffic1 extends StatefulWidget {
  ...
  State<StatefulWidget> createState() {
    return Traffic1State();
  }
}

class Traffic1State extends State<Traffic1> {
  static int scorer = 0;

  final Map<String, bool> score = {};
  final Map<String, Image> choices = {
    'Ambulance': Image.asset('assets/trrafic1/ambulance.png'),
    'ByCycle': Image.asset('assets/trrafic1/bycycle.png'),
    'Taxi': Image.asset('assets/trrafic1/taxi.png'),
    'Truck': Image.asset('assets/trrafic1/truck.png'),
    'Van': Image.asset('assets/trrafic1/van.png'),
  };
  int seed = 0;
                ...
                setState(() {
                  if (score.length == 5) {
                    Navigator.push(
                        context,
                        PageTransition(
                            child: Traffic2(), type: PageTransitionType.fade));
                  }
                });
              },
              ...
              onPressed: () {
                setState(() {
                  Navigator.push(
                      context,
                      PageTransition(
                          child: Traffic1(), type: PageTransitionType.fade));
                });
              },
