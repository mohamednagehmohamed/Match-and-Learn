...
class FootballState extends State<Football> {
  ...
  final Map<String, Image> choices = {
    'Player': Image.asset('assets/football/soccer.png'),
    'GoalKeeper': Image.asset('assets/football/goalkeeper.png'),
    'coach': Image.asset('assets/football/coaching.png'),
    'Caster': Image.asset('assets/football/caster.png'),
    'Refree': Image.asset('assets/football/1193073.png'),
  };
  int seed = 0;
              ...
              onPressed: () {
                setState(() {
                  Navigator.push(
                      context,
                      PageTransition(
                          child: Football(), type: PageTransitionType.fade));
                });
              },
