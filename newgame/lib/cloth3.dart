...
import 'package:walidgame/schools.dart';
...
class Cloth3 extends StatefulWidget {
  @override
...
class Cloth3State extends State<Cloth3> {
  static int scorer = 0;

  final Map<String, bool> score = {};
  final Map<String, Image> choices = {
    'Necklace': Image.asset('assets/clothes3/necklace.png'),
    'Ring': Image.asset('assets/clothes3/ring.png'),
    'Belt': Image.asset('assets/clothes3/seat-belt.png'),
    'Wallet': Image.asset('assets/clothes3/wallet.png'),
    'Watch': Image.asset('assets/clothes3/wristwatch.png'),
  };
  int seed = 0;
                ...
                setState(() {
                  if (score.length == 5) {
                    Navigator.push(
                        context,
                        PageTransition(
                            child: School(), type: PageTransitionType.fade));
                  }
                });
              },
              ...
              onPressed: () {
                setState(() {
                  Navigator.push(
                      context,
                      PageTransition(
                          child: Cloth3(), type: PageTransitionType.fade));
                });
              },
