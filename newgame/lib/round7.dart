...
class Round7State extends State<Round7> {
  static int scorer = 0;

  final Map<String, bool> score = {};
  final Map<String, Image> choices = {
    'GrandFather': Image.asset('assets/people/grandfather.png'),
    'GrandMother': Image.asset('assets/people/grandmother.png'),
    'Father': Image.asset('assets/people/dad.png'),
    'Mother': Image.asset('assets/people/designer.png'),
    'Baby': Image.asset('assets/people/baby-boy.png'),
  };
  int seed = 0;
                  ...
                  if (score.length == 5) {
                    setState(() {
                      ...
                      Navigator.push(
                          context,
                          PageTransition(
                              child: Family1(), type: PageTransitionType.fade));
                    });
                  }
                });
              },
              ...
              onPressed: () {
                setState(() {
                  Navigator.push(
                      context,
                      PageTransition(
                          child: Round7(), type: PageTransitionType.fade));
                });
              },
