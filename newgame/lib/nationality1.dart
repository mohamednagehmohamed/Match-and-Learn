...
class Nationality1 extends StatefulWidget {
  @override
  State<StatefulWidget> createState() {
    return Nationality1State();
  }
}

class Nationality1State extends State<Nationality1> {
  static int scorer = 0;

  final Map<String, bool> score = {};
  final Map<String, Image> choices = {
    'African': Image.asset('assets/natio1/african.png'),
    'Egyption': Image.asset('assets/natio1/egyptian.png'),
    'German': Image.asset('assets/natio1/german.png'),
    'Italian': Image.asset('assets/natio1/italian.png'),
    'Spanish': Image.asset('assets/natio1/spanish.png'),
  };
  int seed = 0;
                ...
                setState(() {
                  if (score.length == 5) {
                    Navigator.push(
                        context,
                        PageTransition(
                            child: Round6(), type: PageTransitionType.fade));
                  }
                });
              },
