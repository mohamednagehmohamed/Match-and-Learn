...
class Fruit2State extends State<Fruit2> {
  static int scorer = 0;

  final Map<String, bool> score = {};
  final Map<String, Image> choices = {
    'Corn': Image.asset('assets/leeek/corn.png'),
    'Cucumber': Image.asset('assets/leeek/cucumber.png'),
    'Leek': Image.asset('assets/leeek/leek.png'),
    'Lettuce': Image.asset('assets/leeek/lettuce.png'),
    'Spinach': Image.asset('assets/leeek/spinach.png'),
  };
  int seed = 0;
