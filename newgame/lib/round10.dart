...
class Round10State extends State<Round10> {
  static int scorer = 0;

  final Map<String, bool> score = {};
  final Map<String, Image> choices = {
    'Circle': Image.asset('assets/shaps/circle.png'),
    'Ellipse': Image.asset('assets/shaps/ellipse.png'),
    'Crescent': Image.asset('assets/shaps/helal.png'),
    'Rectangle': Image.asset('assets/shaps/rectangle.png'),
    'Star': Image.asset('assets/shaps/star.png'),
  };
  int seed = 0;
                ...
                setState(() {
                  if (score.length == 5) {
                    Navigator.push(
                        context,
                        PageTransition(
                            child: Round3(), type: PageTransitionType.fade));
                  }
                });
              },
