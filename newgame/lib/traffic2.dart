...
class Traffic2 extends StatefulWidget {
  @override
  State<StatefulWidget> createState() {
    return Traffic2State();
  }
}

class Traffic2State extends State<Traffic2> {
  static int scorer = 0;

  final Map<String, bool> score = {};
  final Map<String, Image> choices = {
    'Boat': Image.asset('assets/traffic2/boat.png'),
    'Bulldozer': Image.asset('assets/traffic2/bulldozer.png'),
    'Carriage': Image.asset('assets/traffic2/carriage.png'),
    'Motor cycle': Image.asset('assets/traffic2/motor.png'),
    'Tractor': Image.asset('assets/traffic2/tractor.png'),
  };
  int seed = 0;
