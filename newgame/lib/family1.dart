...
class Family1State extends State<Family1> {
  static int scorer = 0;

  final Map<String, bool> score = {};
  final Map<String, Image> choices = {
    'Uncle': Image.asset('assets/family/uncle.png'),
    'Aunt': Image.asset('assets/family/aunt.png'),
    'Boy Cousine': Image.asset('assets/family/cousin.png'),
    'Girl Cousine': Image.asset('assets/family/girlcousin.png'),
    'Baby': Image.asset('assets/family/baby.png'),
  };
  int seed = 0;
