...
class Round13State extends State<Round13> {
  static int scorer = 0;

  final Map<String, bool> score = {};
  final Map<String, Image> choices = {
    'Bus': Image.asset('assets/way/bus.png'),
    'Car': Image.asset('assets/way/car.png'),
    'Plane': Image.asset('assets/way/plane.png'),
    'Ship': Image.asset('assets/way/ship.png'),
    'Train': Image.asset('assets/way/train.png'),
  };
  int seed = 0;
              ...
              onPressed: () {
                setState(() {
                  Navigator.push(
                      context,
                      PageTransition(
                          child: Round13(), type: PageTransitionType.fade));
                });
              },
