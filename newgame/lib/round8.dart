...
class Round8State extends State<Round8> {
  static int scorer = 0;

  final Map<String, bool> score = {};
  final Map<String, Image> choices = {
    'Annoyed': Image.asset('assets/faces/annoyed.png'),
    'Happy': Image.asset('assets/faces/smile.png'),
    'THink': Image.asset('assets/faces/thinking.png'),
    'Sad': Image.asset('assets/faces/sad.png'),
    'Shy': Image.asset('assets/faces/shy.png'),
  };
  int seed = 0;
