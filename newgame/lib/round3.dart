...
class Round3State extends State<Round3> {
  static int scorer = 0;

  final Map<String, bool> score = {};
  final Map<String, Image> choices = {
    '1 + 2': Image.asset('assets/hes/3.png'),
    '2 + 7': Image.asset('assets/hes/9.png'),
    '20 + 1': Image.asset('assets/hes/21.png'),
    '10 + 10': Image.asset('assets/hes/20.png'),
    '3 - 2': Image.asset('assets/hes/1.png'),
  };
  int seed = 0;
