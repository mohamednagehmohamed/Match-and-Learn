...
import 'package:walidgame/cloth.dart';
import 'package:walidgame/help.dart';
...
class Animal3State extends State<Animal3> {
  static int scorer = 0;

  final Map<String, bool> score = {};
  final Map<String, Image> choices = {
    'Penguin': Image.asset('assets/animal3/penguin.png'),
    'Pigeon': Image.asset('assets/animal3/pigeon.png'),
    'Raven': Image.asset('assets/animal3/raven.png'),
    'Robin': Image.asset('assets/animal3/robin.png'),
    'Turkey': Image.asset('assets/animal3/turkey.png'),
  };
  int seed = 0;
                ...
                setState(() {
                  if (score.length == 5) {
                    Navigator.push(
                        context,
                        PageTransition(
                            child: Cloth(), type: PageTransitionType.fade));
                  }
                });
              },
              ...
              onPressed: () {
                setState(() {
                  Navigator.push(
                      context,
                      PageTransition(
                          child: Animal3(), type: PageTransitionType.fade));
                });
              },
