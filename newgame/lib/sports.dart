...
class SportsState extends State<Sports> {
  ...
  final Map<String, Image> choices = {
    'Boxer': Image.asset('assets/sports/boxer.png'),
    'Footballer': Image.asset('assets/sports/football-player.png'),
    'Golf-player': Image.asset('assets/sports/golf-player.png'),
    'Runner': Image.asset('assets/sports/running.png'),
    'Tennis-player': Image.asset('assets/sports/tennis-player.png'),
  };
  int seed = 0;
              ...
              onPressed: () {
                setState(() {
                  Navigator.push(
                      context,
                      PageTransition(
                          child: Sports(), type: PageTransitionType.fade));
                });
              },
