...
class Eat1State extends State<Eat1> {
  static int scorer = 0;

  final Map<String, bool> score = {};
  final Map<String, Image> choices = {
    'Butter': Image.asset('assets/eat1/butter.png'),
    'Eggs': Image.asset('assets/eat1/eggs.png'),
    'Meat': Image.asset('assets/eat1/meat.png'),
    'Pizza': Image.asset('assets/eat1/pizza.png'),
    'Yogurt': Image.asset('assets/eat1/yogurt.png'),
  };
  int seed = 0;
