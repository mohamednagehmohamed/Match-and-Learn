...
class Eat2State extends State<Eat2> {
  static int scorer = 0;

  final Map<String, bool> score = {};
  final Map<String, Image> choices = {
    'Ice Cream': Image.asset('assets/wa/ice.png'),
    'Juice': Image.asset('assets/wa/juice.png'),
    'Milk': Image.asset('assets/wa/milk.png'),
    'Tea': Image.asset('assets/wa/tea.png'),
    'Water': Image.asset('assets/wa/water.png'),
  };
  int seed = 0;
              ...
              onPressed: () {
                setState(() {
                  Navigator.push(
                      context,
                      PageTransition(
                          child: Eat2(), type: PageTransitionType.fade));
                });
              },
