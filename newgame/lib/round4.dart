...
class Round4State extends State<Round4> {
  static int scorer = 0;

  final Map<String, bool> score = {};
  final Map<String, Image> choices = {
    'Carrot': Image.asset('assets/fruits/carrot.png'),
    'Banana': Image.asset('assets/fruits/banana.png'),
    'Tomato': Image.asset('assets/fruits/tomato.png'),
    'Watermelon': Image.asset('assets/fruits/watermelon.png'),
    'cabbage': Image.asset('assets/fruits/cabbage.png'),
  };
  int seed = 0;
