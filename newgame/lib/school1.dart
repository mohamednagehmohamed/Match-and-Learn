...
class School1 extends StatefulWidget {
  @override
...
class School1State extends State<School1> {
  static int scorer = 0;

  final Map<String, bool> score = {};
  final Map<String, Image> choices = {
    'Calculator': Image.asset('assets/school1/calculator.png'),
    'Push-pin': Image.asset('assets/school1/push-pin.png'),
    'Ruler': Image.asset('assets/school1/ruler.png'),
    'Bag': Image.asset('assets/school1/shopping-bag.png'),
    'Stapler': Image.asset('assets/school1/stapler.png'),
  };
  int seed = 0;
                ...
                setState(() {
                  if (score.length == 5) {
                    Navigator.push(
                        context,
                        PageTransition(
                            child: School2(), type: PageTransitionType.fade));
                  }
                });
              },
              ...
              onPressed: () {
                setState(() {
                  Navigator.push(
                      context,
                      PageTransition(
                          child: School1(), type: PageTransitionType.fade));
                });
              },
