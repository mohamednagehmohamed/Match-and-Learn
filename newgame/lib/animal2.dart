...
import 'package:walidgame/animal3.dart';
...
class Animal2State extends State<Animal2> {
  static int scorer = 0;

  final Map<String, bool> score = {};
  final Map<String, Image> choices = {
    'Butterfly': Image.asset('assets/animal2/butterfly.png'),
    'Hen': Image.asset('assets/animal2/hen.png'),
    'Lizard': Image.asset('assets/animal2/lizard.png'),
    'Mice': Image.asset('assets/animal2/mice.png'),
    'Snail': Image.asset('assets/animal2/snail.png'),
  };
  int seed = 0;
              ...
              onPressed: () {
                setState(() {
                  Navigator.push(
                      context,
                      PageTransition(
                          child: Animal2(), type: PageTransitionType.fade));
                });
              },
