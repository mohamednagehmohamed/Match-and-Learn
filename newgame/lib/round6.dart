...
class Round6State extends State<Round6> {
  static int scorer = 0;

  final Map<String, bool> score = {};
  final Map<String, Image> choices = {
    'Egypt': Image.asset('assets/flags/egypt.png'),
    'Brzil': Image.asset('assets/flags/brazil.png'),
    'Argentina': Image.asset('assets/flags/argentina.png'),
    'Iraq': Image.asset('assets/flags/iraq.png'),
    'Germany': Image.asset('assets/flags/germany.png'),
  };
  int seed = 0;
