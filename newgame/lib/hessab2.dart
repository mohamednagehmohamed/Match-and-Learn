...
import 'package:walidgame/traffic.dart';
...
class Hessab extends StatefulWidget {
  @override
...
class HessabState extends State<Hessab> {
  static int scorer = 0;

  final Map<String, bool> score = {};
  final Map<String, Image> choices = {
    '3 X 1': Image.asset('assets/hessab/3.png'),
    '2 X 8': Image.asset('assets/hessab/16.png'),
    '50X 2': Image.asset('assets/hessab/100.png'),
    '10 / 10': Image.asset('assets/hessab/1.png'),
    '30/ 2': Image.asset('assets/hessab/15.png'),
  };
  int seed = 0;
                ...
                setState(() {
                  if (score.length == 5) {
                    Navigator.push(
                        context,
                        PageTransition(
                            child: Traffic(), type: PageTransitionType.fade));
                  }
                });
              },
              ...
              onPressed: () {
                setState(() {
                  Navigator.push(
                      context,
                      PageTransition(
                          child: Hessab(), type: PageTransitionType.fade));
                });
              },
