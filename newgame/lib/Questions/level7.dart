...
import 'package:newgame/Questions/level8.dart';
...
class Level7State extends State<Level7> {
/*  List<AllData> mydata = [
    AllData(
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      child: GestureDetector(
                        ...
                        child: Text(
                          'pick up sodium hydroxide in the lungs',
                    ...
                    Container(
                      ...
                      child: GestureDetector(
                        ...
                        child: Text(
                          'pick up calcium hydroxide in the lungs',
                          style: TextStyle(fontSize: 25, color: Colors.white),
                          overflow: TextOverflow.fade,
                          softWrap: true,
                        ),
                    ...
                    Container(
                      ...
                      child: GestureDetector(
                        ...
                        child: Text(
                          'when hemoglobin picks up carbon dioxide in the lungs',
                          style: TextStyle(fontSize: 25, color: Colors.white),
                          overflow: TextOverflow.fade,
                          softWrap: true,
                        ),
