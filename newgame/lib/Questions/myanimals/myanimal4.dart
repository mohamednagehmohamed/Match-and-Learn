...
import 'package:walidgame/Questions/myanimals/myanimal3.dart';
...
class MyAnimal4 extends StatefulWidget {
  @override
  State<StatefulWidget> createState() {
    return MyAnimal4State();
  }
}

class MyAnimal4State extends State<MyAnimal4> {
/*  List<AllData> mydata = [
    AllData(
                ...
                children: [
                  GestureDetector(
                    ...
                    child: Container(
                      ...
                      child: Center(
                        child: Text(
                            MainLevelState.arabicvalue == false ? 'Bear' : 'دب',
                            style: TextStyle(
