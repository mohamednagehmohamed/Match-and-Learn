...
import 'package:walidgame/animal1.dart';
...
class MyAnimal1 extends StatefulWidget {
  @override
  State<StatefulWidget> createState() {
    return MyAnimal1State();
  }
}

class MyAnimal1State extends State<MyAnimal1> {
/*  List<AllData> mydata = [
    AllData(
