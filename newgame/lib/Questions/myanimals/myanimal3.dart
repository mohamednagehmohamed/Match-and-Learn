...
import 'package:walidgame/Questions/myanimals/myanimal2.dart';
...
class MyAnimal3 extends StatefulWidget {
  @override
  State<StatefulWidget> createState() {
    return MyAnimal3State();
  }
}

class MyAnimal3State extends State<MyAnimal3> {
/*  List<AllData> mydata = [
    AllData(
              ...
              Center(
                ...
                TextSpan(
                    text: MainLevelState.arabicvalue == false
                        ? 'smallest water animal in the world ?'
                        : 'اصغر حيوان مائي في العالم؟',
                    style:
