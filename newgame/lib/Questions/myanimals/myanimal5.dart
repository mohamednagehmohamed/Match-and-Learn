...
import 'package:walidgame/Questions/myanimals/myanimal4.dart';
...
class MyAnimal5 extends StatefulWidget {
  @override
  State<StatefulWidget> createState() {
    return MyAnimal5State();
  }
}

class MyAnimal5State extends State<MyAnimal5> {
/*  List<AllData> mydata = [
    AllData(
