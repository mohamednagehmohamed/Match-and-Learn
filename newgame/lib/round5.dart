...
class Round5State extends State<Round5> {
  static int scorer = 0;

  final Map<String, bool> score = {};
  final Map<String, Image> choices = {
    'Gloves': Image.asset('assets/clothes8/gloves.png'),
    'Trouser': Image.asset('assets/clothes8/trousers.png'),
    'Chemise': Image.asset('assets/clothes8/chemise.png'),
    'Shoose': Image.asset('assets/clothes8/shoose.png'),
    'Cap': Image.asset('assets/clothes8/cap.png'),
  };
  int seed = 0;
              ...
              onPressed: () {
                setState(() {
                  Navigator.push(
                      context,
                      PageTransition(
                          child: Round5(), type: PageTransitionType.fade));
                });
              },
