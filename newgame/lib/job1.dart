...
import 'package:walidgame/jobs.dart';
...
class Job1State extends State<Job1> {
  static int scorer = 0;

  final Map<String, bool> score = {};
  final Map<String, Image> choices = {
    'Actor': Image.asset('assets/jobs1/actor.png'),
    'Lowyer': Image.asset('assets/jobs1/lawyer.png'),
    'Musician': Image.asset('assets/jobs1/musician.png'),
    'Policeman': Image.asset('assets/jobs1/policeman.png'),
    'Waiter': Image.asset('assets/jobs1/waiter.png'),
  };
  int seed = 0;
                ...
                setState(() {
                  if (score.length == 5) {
                    Navigator.push(
                        context,
                        PageTransition(
                            child: Jobs(), type: PageTransitionType.fade));
                  }
                });
              },
              ...
              onPressed: () {
                setState(() {
                  Navigator.push(
                      context,
                      PageTransition(
                          child: Job1(), type: PageTransitionType.fade));
                });
              },
