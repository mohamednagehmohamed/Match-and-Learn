...
class Round12State extends State<Round12> {
  static int scorer = 0;

  final Map<String, bool> score = {};
  final Map<String, Image> choices = {
    'Foot': Image.asset('assets/body/foot.png'),
    'Head': Image.asset('assets/body/head.png'),
    'Hand': Image.asset('assets/body/hello.png'),
    'Leg': Image.asset('assets/body/leg.png'),
    'Arm': Image.asset('assets/body/muscle.png'),
  };
  int seed = 0;
                ...
                setState(() {
                  if (score.length == 5) {
                    Navigator.push(
                        context,
                        PageTransition(
                            child: Finish(), type: PageTransitionType.fade));
                  }
                });
              },
              ...
              onPressed: () {
                setState(() {
                  Navigator.push(
                      context,
                      PageTransition(
                          child: Round12(), type: PageTransitionType.fade));
                });
              },
