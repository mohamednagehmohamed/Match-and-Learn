...
class Emotions1 extends StatefulWidget {
  @override
  State<StatefulWidget> createState() {
    return Emotions1State();
  }
}

class Emotions1State extends State<Emotions1> {
  static int scorer = 0;

  final Map<String, bool> score = {};
  final Map<String, Image> choices = {
    'Angey': Image.asset('assets/emoji/angry.png'),
    'Happy': Image.asset('assets/emoji/joy.png'),
    'Love': Image.asset('assets/emoji/love.png'),
    'Fear': Image.asset('assets/emoji/scared.png'),
    'surprised': Image.asset('assets/emoji/surprised.png'),
  };
  int seed = 0;
                ...
                setState(() {
                  if (score.length == 5) {
                    Navigator.push(
                        context,
                        PageTransition(
                            child: Fruit(), type: PageTransitionType.fade));
                  }
                });
              },
              ...
              onPressed: () {
                setState(() {
                  Navigator.push(
                      context,
                      PageTransition(
                          child: Emotions1(), type: PageTransitionType.fade));
                });
              },
