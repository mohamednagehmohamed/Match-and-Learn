...
class Round9State extends State<Round9> {
  static int scorer = 0;

  final Map<String, bool> score = {};
  final Map<String, Image> choices = {
    'Pen': Image.asset('assets/tools/pen.png'),
    'Pencil': Image.asset('assets/tools/pencil.png'),
    'Eraser': Image.asset('assets/tools/eraser.png'),
    'Book': Image.asset('assets/tools/book.png'),
    'Notebook': Image.asset('assets/tools/notebook.png'),
  };
  int seed = 0;
  ...
  Widget build(BuildContext context) {
    double size = MediaQuery.of(context).size.width * 0.070;
    return WillPopScope(
              ...
              onPressed: () {
                setState(() {
                  Navigator.push(
                      context,
                      PageTransition(
                          child: Round9(), type: PageTransitionType.fade));
                });
              },
