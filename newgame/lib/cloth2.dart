...
class Cloth2 extends StatefulWidget {
  @override
...
class Cloth2State extends State<Cloth2> {
  static int scorer = 0;

  final Map<String, bool> score = {};
  final Map<String, Image> choices = {
    'Blouse': Image.asset('assets/clothes2/blouse.png'),
    'Boot': Image.asset('assets/clothes2/boot.png'),
    'Vest': Image.asset('assets/clothes2/construction-vest.png'),
    'Dress': Image.asset('assets/clothes2/dress.png'),
    'Pajamas': Image.asset('assets/clothes2/pajamas.png'),
  };
  int seed = 0;
              ...
              onPressed: () {
                setState(() {
                  Navigator.push(
                      context,
                      PageTransition(
                          child: Cloth2(), type: PageTransitionType.fade));
                });
              },
